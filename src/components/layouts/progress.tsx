...
export default function Progress(props:{percent:number,text:string, color?:Color}){
    ...
    return (
        <div className={''}>
            <CircularProgressbar value={props.percent} text={`${props.percent.toLocaleString().split('.')[0]}%`}
                                 strokeWidth={10} className={'w-[65px] h-[60px] sm:w-[60px] sm:h-[60px] md:w-[60%] md:h-[60%]'}
